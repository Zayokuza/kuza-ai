...
██║  ██╗╚██████╔╝███████╗██║  ██║
╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
[/bold blue][dim]KUZA · v{KUZA_VERSION} · Local AI Assistant · Termux[/dim]
"""
...
def run_init():
    ...
    from core.kuzamd import get_init_prompt, write_kuzamd, find_kuzamd
...
[bold]Environment variables:[/bold]
  ...
  KUZA_MODEL                  Override model path
  KUZA_THREADS                Override thread count
        """)
        return True, history
